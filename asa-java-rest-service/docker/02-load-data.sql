...
-- customer_profile
INSERT INTO customer_profile(id, first_name, last_name, email)
VALUES
    (1, 'Eric', 'Manley', 'me_manley@yahoo.com'),
    (2, 'Steve','Watkins', 'swatkins@yahoo.com'),
    (3, 'Jon','Snow', 'jsnow@got.com'),
    (4, 'Tyrion','Lannister', 'tlannister@got.com');
